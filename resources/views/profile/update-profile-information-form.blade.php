<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Update your account\'s profile information y email address.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="user" type="text" class="mt-1 block w-full" wire:model.defer="state.user" autocomplete="user" />
